...
### 3.2 スプラッシュスクリーン（オープニングロゴアニメーション）
```html
<!-- スプラッシュスクリーン（ロゴアニメーション） -->
<div class="splash-screen" id="splashScreen">
  <div class="splash-content">
    <img src="img/My work Galleryロゴ画像2.png" alt="My work Gallery" class="splash-logo">
    <div class="splash-text">My work Gallery</div>
...
.splash-logo {
  width: 150px;
  height: auto;
  animation: splashLogoAppear 1s ease-out forwards, splashLogoFloat 3s ease-in-out 1s infinite;
  opacity: 0;
  transform: scale(0.5) rotate(-10deg);
  filter: drop-shadow(0 0 30px var(--accent-glow)) drop-shadow(0 0 60px var(--accent-glow-purple));
}

@keyframes splashLogoAppear {
  0% { opacity: 0; transform: scale(0.5) rotate(-10deg); filter: drop-shadow(0 0 0 transparent); }
  50% { opacity: 1; transform: scale(1.1) rotate(5deg); filter: drop-shadow(0 0 40px var(--accent-glow)) drop-shadow(0 0 80px var(--accent-glow-purple)); }
  100% { opacity: 1; transform: scale(1) rotate(0deg); filter: drop-shadow(0 0 30px var(--accent-glow)) drop-shadow(0 0 60px var(--accent-glow-purple)); }
}
...
.splash-text {
  ...
  animation: splashTextAppear 0.8s ease-out 0.3s forwards, gradientShift 5s ease infinite;
  opacity: 0;
...
.splash-loader {
  ...
  border-radius: 3px;
  overflow: hidden;
  animation: splashLoaderAppear 0.5s ease-out 0.5s forwards;
  opacity: 0;
}
...
.splash-loader-bar {
  ...
  background: var(--accent-gradient);
  border-radius: 3px;
  animation: splashLoaderProgress 1.5s ease-in-out 0.7s forwards;
